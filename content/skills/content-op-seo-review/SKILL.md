...
Calls `content-task-flag-seo-gap` for each keyword or content piece requiring immediate action. Writes a dated SEO brief to vault/content/00_current/ and updates open-loops.
...
2. Call `content-flow-build-seo-summary` for quick-win list, ranking drops, gap analysis, and top 3 opportunities
...
5. For each opportunity in the top 3 list: call `content-task-flag-seo-gap` to write a prioritized action item to open-loops
...
9. Call `content-task-update-open-loops` for any ranking drops or gaps not already flagged by the flag-seo-gap task
