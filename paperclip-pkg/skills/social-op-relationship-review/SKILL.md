...
- **No interaction log data:** Cannot calculate last-contact dates — display contacts with "No interactions logged" health status; recommend running task-log-interaction to populate.
