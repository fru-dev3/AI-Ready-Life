...
1. Call `task-extract-income-ytd` to get structured YTD income by source type
...
4. Calculate Method A (Safe Harbor) by calling `flow-safe-harbor-calc`; subtract withholding and prior payments to get net quarterly amount
