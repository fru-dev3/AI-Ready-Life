...
- `op-document-sync` — download completed return PDFs for archive and future reference
- `flow-build-estimate` — read prior year AGI (line 11) and total tax (line 24) for safe harbor calculation
